...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 md:py-4">
        <motion.div
        ...
        >
          <span className="hidden sm:inline">Campus Recruitment </span>
          <span className="sm:hidden">CRP</span>
            ...
            <div className="flex items-center gap-2">
              <Link to="/login">
                <motion.div whileHover={{ scale: 1.05 }}>
                  <Button variant="outline" className="text-sm px-3 py-1.5 lg:px-4 lg:py-2">
                    Login
                  </Button>
                </motion.div>
              </Link>
              <Link to="/signup">
                <motion.div whileHover={{ scale: 1.05 }}>
                  <Button className="bg-[#6A38C2] hover:bg-[#5b30a6] text-sm px-3 py-1.5 lg:px-4 lg:py-2">
                    Signup
                  </Button>
                </motion.div>
              </Link>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="md:hidden px-4 sm:px-6 pb-4 bg-gray-50"
